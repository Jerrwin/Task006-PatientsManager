            ...
            <div class="row text-center">
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card bg-white shadow-sm p-3 h-100">
                        <h5 class="text-secondary">Total Visits</h5>
                ...
                <table class="table table-hover table-striped mb-0">
                    <thead class="table-dark">
                        <tr class="text-center">
                            ...
                            <th class="text-nowrap">Consultation</th>
                            <th class="text-nowrap">Lab Fee</th>
                        ...
                        <?php if ($history->num_rows > 0): ?>
                            <?php while ($row = $history->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td class="text-nowrap"><?php echo $row['days_ago']; ?> days</td>

                                    <td>₹<?php echo $row['consultation_fee']; ?></td>
                                    <td>₹<?php echo $row['lab_fee']; ?></td>

                                    <td class="fw-bold text-success">
                                        ₹<?php echo $row['consultation_fee'] + $row['lab_fee']; ?>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="5" class="text-center py-4">No history found for this patient.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
