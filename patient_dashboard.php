                ...
                <div class="card-body text-center">
                    ...
                    <div class="text-start">
                        <?php if ($patient_data): ?>
                            ...
                            <p class="mb-2"><strong>Joined:</strong> <?php echo date('d-M-Y', strtotime($patient_data['join_date'])); ?></p>
                            <p class="mb-0"><strong>Address:</strong><br><?php echo nl2br(htmlspecialchars($patient_data['address'])); ?></p>
                        <?php else: ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-4 text-nowrap fw-bold">
                                            ...
                                            <div class="small text-muted fw-normal"><?php echo $row['days_ago']; ?> days ago</div>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-column">
                                                <span>Consultation: <strong>₹<?php echo $row['consultation_fee']; ?></strong></span>
                                                <small class="text-muted">Lab Fee: ₹<?php echo $row['lab_fee']; ?></small>
                                            </div>
                                        </td>
                                        <td>
