...
switch ($sort_option) {
    ...
    case 'visits_high':   $order_sql = "total_visits DESC"; break;
    case 'visits_low':    $order_sql = "total_visits ASC"; break;
    case 'recent_visit':  $order_sql = "last_visit DESC"; break;
    case 'oldest_visit':  $order_sql = "last_visit ASC"; break;
    case 'status':        $order_sql = "status_label ASC"; break;
    default:              $order_sql = "last_visit DESC";
}
    ...
    <div class="row mb-5 g-4">
        <div class="col-md-4">
            <div class="card bg-primary text-white h-100 shadow">
                <div class="card-body text-center">
                    <h4>
                        <img src="../assets/icons/calendar.png" alt="" width="26" height="26" style="filter: brightness(0) invert(1); margin-bottom: 4px;"> 
                        Follow-Up Report
                    </h4>
        ...
        <div class="col-md-4">
            <div class="card bg-success text-white h-100 shadow">
                <div class="card-body text-center">
                    <h4>
                        <img src="../assets/icons/trends.png" alt="" width="26" height="26" style="filter: brightness(0) invert(1); margin-bottom: 5px;"> 
                        Monthly Trends
                    </h4>
        ...
        <div class="col-md-4">
            <div class="card bg-warning text-dark h-100 shadow">
                <div class="card-body text-center">
                    <h4>
                        <img src="../assets/icons/birthday-cake.png" alt="" width="26" height="26" style="margin-bottom: 4px;">
                        Birthday Forecast
                    </h4>
                ...
                <div class="col-md-3">
                    <div class="input-group input-group-sm">
                        <select name="sort" class="form-select" onchange="this.form.submit()">
                            <option value="recent_visit" <?php if($sort_option=='recent_visit') echo 'selected'; ?>>Most Recent Visit</option>
                            <option value="oldest_visit" <?php if($sort_option=='oldest_visit') echo 'selected'; ?>>Oldest Visit</option>
                            <option value="visits_high" <?php if($sort_option=='visits_high') echo 'selected'; ?>>Total Visits (High)</option>
                            <option value="visits_low" <?php if($sort_option=='visits_low') echo 'selected'; ?>>Total Visits (Low)</option>
                            <option value="name_asc" <?php if($sort_option=='name_asc') echo 'selected'; ?>>Name (A-Z)</option>
                            <option value="status" <?php if($sort_option=='status') echo 'selected'; ?>>Status</option>
                        </select>
            ...
            <table class="table table-hover mb-0 text-center align-middle">
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="7" class="text-center py-4">No records found matching your search.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        ...
        <nav class="mt-4 d-flex justify-content-end">
            <ul class="pagination">
                <li class="page-item <?php if($page <= 1) echo 'disabled'; ?>">
                    <a class="page-link" href="?page=<?php echo $page-1; ?>&search=<?php echo $search; ?>&sort=<?php echo $sort_option; ?>">Previous</a>
                </li>
                
                <?php for($i=1; $i <= $total_pages; $i++): ?>
                    <li class="page-item <?php if($page == $i) echo 'active'; ?>">
                        <a class="page-link" href="?page=<?php echo $i; ?>&search=<?php echo $search; ?>&sort=<?php echo $sort_option; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>

                <li class="page-item <?php if($page >= $total_pages) echo 'disabled'; ?>">
                    <a class="page-link" href="?page=<?php echo $page+1; ?>&search=<?php echo $search; ?>&sort=<?php echo $sort_option; ?>">Next</a>
                </li>
            </ul>
        </nav>
    <?php endif; ?>
